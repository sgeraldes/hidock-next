...
class SafeCommandTester:
    ...
    def safe_command_test(self, command_id: int, parameters: bytes, description: str = "", skip_health_check: bool = False) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            # Pre-test health check (optional)
            ...
            # Post-test health check (optional)
            if not skip_health_check:
