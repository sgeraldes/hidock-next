    ...
    for i, param_data in enumerate(parameters, 1):
        ...
        try:
            ...
            if success and response != "":
                print("[!!!] BREAKTHROUGH: NON-EMPTY RESPONSE DETECTED!")
                print(f"[!!!] Response: '{response}'")
...
def main():
    ...
    try:
        ...
        cmd14_results, interesting_14 = test_command_with_structured_parameters(14, structured_params, tester)

        # Test Command 15 with structured parameters
        print("\\n[*] TESTING COMMAND 15 WITH STRUCTURED PARAMETERS")
        cmd15_results, interesting_15 = test_command_with_structured_parameters(15, structured_params, tester)

        # Advanced analysis
        print("\\n[*] PERFORMING ADVANCED ANALYSIS")
        all_interesting = analyze_advanced_results(cmd14_results, cmd15_results, interesting_14, interesting_15)

        # Save results
        results_file = save_advanced_results(cmd14_results, cmd15_results, all_interesting)
