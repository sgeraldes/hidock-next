...
def generate_metadata(firmware_entry, binary_data, xml_content, partitions, extracted_partitions, validation_results):
    ...
    metadata = {
        ...
        "partitions": {"count": len(partitions), "total_size": sum(p["size"] for p in partitions), "details": []},
        "download_info": {
...
def main():
    ...
    try:
        ...
        metadata = generate_metadata(
            firmware_entry, binary_data, xml_content, partitions, extracted_partitions, validation_results
        )
