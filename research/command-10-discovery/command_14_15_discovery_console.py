#!/usr/bin/env python3
"""
Command 14 & 15 Systematic Discovery Script (Console-Safe)
    ...
    for i, (param_bytes, description) in enumerate(parameters, 1):
        ...
        try:
            ...
            if success and response != "":
                print("[!] INTERESTING: Non-empty response detected!")
...
def main():
    ...
    try:
        ...
        print(f"\n[*] Estimated time: {len(parameters) * 2 * 2} seconds for both commands")
        ...
        if interesting_results:
            print(f"\n[SUCCESS] POTENTIAL BREAKTHROUGH: Found {len(interesting_results)} interesting responses!")
