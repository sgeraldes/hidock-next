@echo off
REM HiDock Meeting Recorder - Launch Script
setlocal
...
REM Check if meeting-recorder app directory exists
...
REM Navigate to meeting-recorder app directory
...
REM Run the meeting-recorder app in development mode
call npm run dev
