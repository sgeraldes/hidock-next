...
# Mock a simple config dictionary that the service expects
def create_mock_config():
    """Create a mock config dictionary for testing."""
    return {
        'calendar_provider': 'outlook',
        'calendar_outlook_client_id': 'test_client_id',
        'calendar_outlook_client_secret_encrypted': 'test_secret',
...
def test_outlook_calendar_service():
    ...
    service = OutlookCalendarService(mock_config)
