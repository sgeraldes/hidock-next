...
class CalendarCacheManager:
        ...
        try:
            with self._cache_lock:
                ...
                cached_meeting = CachedMeeting(
                    ...
                    display_text=self._format_meeting_display_text(simple_meeting),
    ...
    def _format_meeting_display_text(self, simple_meeting: Any) -> str:
        ...
        # Add organizer if available and different from subject
        if simple_meeting.organizer and simple_meeting.organizer.strip():
