...
class TestSettingsPersistenceIsolated(unittest.TestCase):
    ...
    def _create_mock_parent_gui(self):
        ...
        mock_parent.recording_check_interval_var = ctk.StringVar(value=str(self.test_config['recording_check_interval_s']))
        ...
        mock_parent.default_command_timeout_ms_var = ctk.StringVar(value=str(self.test_config['default_command_timeout_ms']))
    ...
    def test_apply_button_saves_to_file(self):
        ...
        self.assertEqual(saved_config['autoconnect'], True,
                        "Apply button should save changes to config file")
    ...
    def test_ok_button_saves_to_file(self):
        ...
        self.assertEqual(saved_config['autoconnect'], True,
                        "OK button should save changes to config file")
    ...
    def test_settings_from_different_tabs_all_saved(self):
        ...
        self.assertEqual(saved_config['autoconnect'], True,
                        "General tab setting should be saved")
        self.assertEqual(saved_config['recording_check_interval_s'], 25,
                        "Operation tab setting should be saved")
        self.assertEqual(saved_config['log_level'], 'DEBUG',
                        "Logging tab setting should be saved")
    ...
    def test_identify_real_persistence_issue(self):
        ...
        self.assertEqual(reloaded['test_setting'], 'test_value',
                        "Basic config file operations should work")
        ...
        self.assertEqual(final_config['autoconnect'], not original_autoconnect,
                        "Settings dialog should save autoconnect changes to file")
        self.assertEqual(final_config['log_level'], new_log_level,
                        "Settings dialog should save log level changes to file")
