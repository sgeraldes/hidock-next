...
export interface ElectronAPI {
  ...
  graph: {
    ...
    ingestAll: () => Promise<{ success: boolean; data?: { ingested: number; skipped: number; extractionFailures?: number; errors: Array<{ transcriptId: string; error: string; errorCategory?: 'extraction_error' | 'schema_error' }>; results?: Array<{ transcriptId: string; status: 'success' | 'skipped' | 'privacy_blocked' | 'extraction_error' | 'schema_error' | 'error'; errorCategory?: 'extraction_error' | 'schema_error'; errorSummary?: string }> }; error?: string }>
    ...
    ingestFolder: (folderPath: string) => Promise<{ success: boolean; data?: { ingested: number; skipped: number; extractionFailures?: number; errors: Array<{ transcriptId: string; error: string; errorCategory?: 'extraction_error' | 'schema_error' }>; results?: Array<{ transcriptId: string; status: 'success' | 'skipped' | 'privacy_blocked' | 'extraction_error' | 'schema_error' | 'error'; errorCategory?: 'extraction_error' | 'schema_error'; errorSummary?: string }> }; error?: string }>
