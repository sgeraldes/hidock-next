...
if __name__ == '__main__':
    ...
    print(f"   https://login.microsoftonline.com/.../authorize?")
    print(f"     client_id=YOUR_CLIENT_ID")
    print(f"     &redirect_uri=http://localhost:8080/callback")
    ...
    print(f"   POST https://login.microsoftonline.com/.../token")
    print(f"   Body:")
    ...
    print(f"   If match: Returns access token ✓")
    print(f"   If mismatch: Returns error ✗\n")
