...
class ToastNotification:
    ...
    def __init__(
        ...
        self.colors = {
            "success": {"bg": "#4CAF50", "text": "#FFFFFF", "border": "#45A049", "icon": "✓"},
            "warning": {"bg": "#FF9800", "text": "#FFFFFF", "border": "#F57C00", "icon": "⚠"},
            "error": {"bg": "#F44336", "text": "#FFFFFF", "border": "#E53935", "icon": "✕"},
            "info": {"bg": "#2196F3", "text": "#FFFFFF", "border": "#1976D2", "icon": "ⓘ"},
        }
...
class ToastManager:
    ...
    def show_toast(
        ...
        toast = ToastNotification(
            self.parent, message=message, title=title, toast_type=toast_type, duration=duration, position=position
        )
